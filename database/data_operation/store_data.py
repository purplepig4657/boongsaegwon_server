...
def insert_store_info(store_id, name, store_name, category, store_description=None,
    ...
    column = ["store_id", "name", "store_name", "category", "store_description", "store_open_info", "store_photo", "menu_info"]
    data = [store_id, name, store_name, category, store_description, store_open_info, store_photo, menu_info]
